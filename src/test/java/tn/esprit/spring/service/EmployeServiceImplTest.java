...
public class EmployeServiceImplTest
{
	private static final Logger l = LogManager.getLogger(EmployeServiceImpl.class);
		...
		public void testModifyEmploye() throws ParseException   {
			SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
			Date d = dateFormat.parse("2015-03-23");
			Employe e = new Employe(6,"Mzoughi1","Mahdi1", "mahdi.mzoughi@esprit.tn" ,"123456789" ,true, Role.INGENIEUR); 
		...
		public void testRetrieveEmploye() {
			Employe EmployeRetrieved = es.retrieveEmploye(6); 
			Assertions.assertEquals(6L, EmployeRetrieved.getId());
		}
		...
		public void testDeleteEmploye() {
			...
			es.deleteEmploye(4);
			Assertions.assertNull(es.retrieveEmploye(4));
